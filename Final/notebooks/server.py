...
def upload_file():
    if request.method == 'POST':
        ...
        if file:
            ...
            prediction = list(classification_model.predict(preprocessed_img)[0])
            ...
            return render_template('result_Three.html', predicted_classes = sorted_predicted_classes, img_path=img_path)
